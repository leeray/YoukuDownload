...
class DownloadTudou():
    ...
    def anzhuoshichang_1(self, nettype='WIFI', model='MI 2', mac='c4:6a:b7:4e:e3:36', device='867064014692428'):
        ...
        url = 'http://market.hiapk.com/service/api2.php?qt=9001&apk=1423085&sign=416b23f9fe509057bbebe8ef78dd12e9&lowapkmd5=null&type=1&source=1'
        req['url'] = url
        req['header'] = headers;
        req['method'] = 'GET'
        req['package'] = False
    ...
    def anzhuoshichang_2(self, nettype='WIFI', model='MI 2', mac='c4:6a:b7:4e:e3:36', device='867064014692428'):
        ...
        url = 'http://cdn.market.hiapk.com/data/upload//2013/04_28/15/com.youku.phone_151251.apk';
        req['url'] = url
        req['method'] = 'GET'
        req['package'] = True
        return req
